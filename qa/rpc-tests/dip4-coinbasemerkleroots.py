...
from test_framework.test_framework import HashShareCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(HashShareCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as HashShareCoinTestFramework doesn't support this atm)
