...
official/supported Docker Images found at https://hub.docker.com/r/hashsharecoinpay/hashsharecoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/hashsharecoinpay/hashsharecoind-develop/ when changing the above text**
