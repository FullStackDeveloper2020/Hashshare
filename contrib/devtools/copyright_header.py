...
Arguments:
    <base_directory> - The base directory of a HashShareCoin Core source code repository.
...
Arguments:
    <base_directory> - The base directory of HashShareCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the HashShareCoin Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The HashShareCoin
