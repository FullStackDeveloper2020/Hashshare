...
This mechanism has been integrated into Bitcore-Node-HashShareCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hashsharecoinpay/insight-api-hashsharecoin#web-socket-api](https://github.com/hashsharecoinpay/insight-api-hashsharecoin#web-socket-api)
* API: [https://github.com/hashsharecoinpay/insight-api-hashsharecoin#instantsend-transactions](https://github.com/hashsharecoinpay/insight-api-hashsharecoin#instantsend-transactions)
