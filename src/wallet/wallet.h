...
public:
    ...
    bool IsLockedByInstaHSS() const;
    bool IsLockedByLLMQInstaHSS() const;
...
public:
    ...
    uint64_t nStakeSplitThreshold = 115;
    ...
    /// Get 1000 HSS output and keys which can be used for the Masternode
