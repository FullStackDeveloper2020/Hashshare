...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward, bool fTestnet)
{
	...
	const CScript genesisOutputScript = fTestnet ?
		...
		CScript() << ParseHex("0411345e927d2d3aba81543e23b271f5a9013a2c240fb9bd4b1c14249393639293846cfc74152d293a3bf7ba74592f5f358127cb062a621d3b153089d0b5bb84e5") << OP_CHECKSIG;
...
public:
	CMainParams() {
	   ...
	   ///////////////////////////////////////////////
        consensus.nGenerationAmount = 192.5 * COIN;
		...
		*/
		...
		vAlertPubKey = ParseHex("048403aa4b7052cfca5740f8a12c7390880f2ea782c9119e5a0c3dcd9ec176a295502acd665709f8abd00963667317ba5b6dd47f16a507011649922d99af1647a2");
		nDefaultPort = 1317;
		nPruneAfterHeight = 2000000;

		genesis = CreateGenesisBlock(1576234800, 53954, 0x1e0ffff0, 1, 50 * COIN, false);
		consensus.hashGenesisBlock = genesis.GetHash();
		assert(consensus.hashGenesisBlock == uint256S("0x0000011cb50e3244025f1cca6a71736be5c9180dff8efaf09d7c68697a7b03ac"));
		assert(genesis.hashMerkleRoot == uint256S("0x003df0b1866d6a1f7fd43c443c255ba41a43ee6dac2c04fc14285751cd022760"));
		...
		// HSS script addresses start with '5'
		base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 10);
		// HSS private keys start with '7' or 'X'
		base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 204);
		// HSS BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
		base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
		// HSS BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
		base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

		// HSS BIP44 coin type is '5'
		nExtCoinType = 5;
		...
		consensus.llmqForInstaHSS = Consensus::LLMQ_50_60;
		...
		vSporkAddresses = { "SRiU2GiAn1bxbDZJS5d41v1yiJKf7WTBm2" };
		nMinSporkKeys = 1;
		fBIP9CheckMasternodesUpgraded = true;

				checkpointData = (CCheckpointData) {
			boost::assign::map_list_of
			(0, uint256S("0x0000011cb50e3244025f1cca6a71736be5c9180dff8efaf09d7c68697a7b03ac"))
			(1, uint256S("0x00000e1fd44865928bee6d3088237ad9e29b20aa5dcadf91424dfb25b5efb8d5"))
			(489, uint256S("0x3a5d92c9c4eb39f009ca787bbb287334753bf9d1cda4cfd614149dfd3289728f"))
			(3742, uint256S("0xa201249bce14cc9c04d2d8adde9164c6d7af19e7a85fe4e6b31055e74155a52c"))
			(5601, uint256S("0xd1ebaa2d78e7e8c7e02a35b358c22a44cd03b159762895e8562d1cff915b7b62"))
...
public:
	CTestNetParams() {
		...
		// Testnet HashShareCoin addresses start with 'y'
		base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140);
		// Testnet HashShareCoin script addresses start with '8' or '9'
		base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
		// Testnet private keys start with '9' or 'c' (Bitcoin defaults)
		base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
		// Testnet HashShareCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
		base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
		// Testnet HashShareCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
		...
		consensus.llmqForInstaHSS = Consensus::LLMQ_5_60;
...
public:
	CDevNetParams() {
		...
		consensus.nPowTargetTimespan = 24 * 60 * 60; // HashShareCoin: 1 day
		consensus.nPowTargetSpacing = 2.5 * 60; // HashShareCoin: 2.5 minutes
		consensus.nPosTargetSpacing = consensus.nPowTargetSpacing;
		consensus.nPosTargetTimespan = consensus.nPowTargetTimespan;
		...
		vFixedSeeds.clear();
		vSeeds.clear();
		//vSeeds.push_back(CDNSSeedData("hashsharecoinevo.org",  "devnet-seed.hashsharecoinevo.org"));
...
public:
	CRegTestParams() {
		...
		// Regtest HashShareCoin addresses start with 'y'
		base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140);
		// Regtest HashShareCoin script addresses start with '8' or '9'
		base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
		// Regtest private keys start with '9' or 'c' (Bitcoin defaults)
		base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
		// Regtest HashShareCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
		base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
		// Regtest HashShareCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
		base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

		// Regtest HashShareCoin BIP44 coin type is '1' (All coin's testnet default)
		nExtCoinType = 1;
