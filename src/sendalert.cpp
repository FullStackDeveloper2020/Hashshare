...
2. run hashsharecoind with -printalert or -sendalert like this:
   /path/to/hashsharecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.hashsharecoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/HashShareCoin Core:0.12.0.58/"));
