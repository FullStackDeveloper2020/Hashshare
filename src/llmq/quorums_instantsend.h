...
#ifndef HASHSHARECOIN_QUORUMS_INSTANTSEND_H
#define HASHSHARECOIN_QUORUMS_INSTANTSEND_H
...
// SPORK_2_INSTANTSEND_ENABLED generally enables/disables InstaHSS and SPORK_20_INSTANTSEND_LLMQ_BASED switches
...
#endif//HSS_QUORUMS_INSTANTSEND_H
