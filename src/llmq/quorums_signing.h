...
#ifndef HASHSHARECOIN_QUORUMS_SIGNING_H
#define HASHSHARECOIN_QUORUMS_SIGNING_H
...
public:
    ...
    // This is the case for example when a signature appears as part of InstaHSS or ChainLocks
    ...
    // mechanism prevents possible conflicts. As an example, ChainLocks prevent conflicts in confirmed TXs InstaHSS votes
    void RemoveRecoveredSig(Consensus::LLMQType llmqType, const uint256& id);
