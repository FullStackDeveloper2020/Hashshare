    ...
    transactionView(0), abandonAction(0), columnResizingFixer(0)
{
    ...
    instantsendWidget->addItem(tr("All"), TransactionFilterProxy::InstaHSSFilter_All);
    instantsendWidget->addItem(tr("Locked by InstaHSS"), TransactionFilterProxy::InstaHSSFilter_Yes);
    instantsendWidget->addItem(tr("Not locked by InstaHSS"), TransactionFilterProxy::InstaHSSFilter_No);
    ...
    connect(instantsendWidget, SIGNAL(activated(int)), this, SLOT(chooseInstaHSS(int)));
...
void TransactionView::setModel(WalletModel *_model)
{
    ...
    if(_model)
    {
        ...
        transactionView->setColumnWidth(TransactionTableModel::InstaHSS, INSTANTSEND_COLUMN_WIDTH);
...
void TransactionView::chooseInstaHSS(int idx)
{
    if(!transactionProxyModel)
        return;
    transactionProxyModel->setInstaHSSFilter(
        (TransactionFilterProxy::InstaHSSFilter)instantsendWidget->itemData(idx).toInt());
}
...
void TransactionView::showAddressQRCode()
{
    ...
    dialog->setInfo(tr("QR code"), "hashsharecoin:"+strAddress, "", strAddress);
    dialog->show();
}
