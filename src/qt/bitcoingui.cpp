...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hss: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about HashShareCoin"));
    ...
    openAction->setStatusTip(tr("Open a hss: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible HashShareCoin command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("HashShareCoin"); // default title
