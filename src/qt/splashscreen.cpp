    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextHashShareCoin   = QChar(0xA9) + QString("2019 ") + QString(tr("The HashShareCoin developers"));
    ...
    pixPaint.drawText(paddingLeft, 467, copyrightTextHashShareCoin);
