...
QVariant TransactionTableModel::txInstaHSSDecoration(const TransactionRecord *wtx) const
{
    if (wtx->status.lockedByInstaHSS) {
        QString theme = GUIUtil::getThemeName();
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case RawDecorationRole:
        ...
        case InstaHSS:
            return txInstaHSSDecoration(rec);
        case ToAddress:
    ...
    case Qt::EditRole:
        ...
        case InstaHSS:
            return (rec->status.lockedByInstaHSS ? 1 : 0);
        case ToAddress:
    ...
    case Qt::ForegroundRole:
        ...
        if(rec->status.lockedByInstaHSS)
        {
    ...
    case WatchonlyDecorationRole:
        return txWatchonlyDecoration(rec);
    case InstaHSSRole:
        return rec->status.lockedByInstaHSS;
    case InstaHSSDecorationRole:
        return txInstaHSSDecoration(rec);
...
QVariant TransactionTableModel::headerData(int section, Qt::Orientation orientation, int role) const
{
    if(orientation == Qt::Horizontal)
    {
        ...
        } else if (role == Qt::ToolTipRole)
        {
            ...
            case InstaHSS:
                return tr("Whether or not this transaction was locked by InstaHSS.");
            case ToAddress:
