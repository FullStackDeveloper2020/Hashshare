...
/*
    ...
    one party without compromising the security of InstaHSS
...
/**
 * Manages InstaHSS. Processes lock requests, candidates, and votes.
 */
class CInstantSend
{
public:
...
/**
 * An InstaHSS transaction lock request.
 */
class CTxLockRequest
{
private:
...
/**
 * An InstaHSS transaction lock vote. Sent by a masternode in response to a
...
/**
 * An InstaHSS transaction lock candidate.
 */
class CTxLockCandidate
{
private:
