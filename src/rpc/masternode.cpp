...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress     - Print the masternode owner HashShareCoin address\n"
            "  payee            - Print the masternode payout HashShareCoin address (can be additionally filtered,\n"
            "                     partial match)\n"
            "  pubKeyOperator   - Print the masternode operator public key\n"
            "  status           - Print masternode status: ENABLED / POSE_BANNED\n"
            "                     (can be additionally filtered, partial match)\n"
            "  votingaddress    - Print the masternode voting HashShareCoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hashsharecoin",               "masternode",             &masternode,             true,  {} },
    { "hashsharecoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "hashsharecoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "hashsharecoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
