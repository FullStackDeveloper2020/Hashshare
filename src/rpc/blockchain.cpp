...
std::string EntryDescriptionString()
{
    return "    \"size\" : n,                 (numeric) transaction size in bytes\n"
           ...
           "       ... ],\n"
           "    \"instantsend\" : true|false, (boolean) True if this transaction was sent as an InstaHSS one\n"
           "    \"instantlock\" : true|false  (boolean) True if this transaction was locked via InstaHSS\n";
}
